...
import static uk.ac.aber.dcs.cs31620.faaversion6.model.Gender.MALE;
/**
            ...
            synchronized (FaaRoomDatabase.class){
                if (INSTANCE == null){
                    ...
                    INSTANCE = Room.databaseBuilder(context.getApplicationContext(),
                            FaaRoomDatabase.class, "faa_database").allowMainThreadQueries().addCallback(sRoomDatabaseCallback).build();
